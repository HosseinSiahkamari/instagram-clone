    ...
    return (
        <div className='w-96 h-[739px] pl-8 mt-6 '>
            <div className="flex items-center justify-center h-12 w-72 mt-10">
                ...
                <span className='text-sky-500 text-xs font-semibold'>Switch</span>
            </div>
            <div className='flex items-center w-72 h-5 mt-10 mb-5'>
                ...
                <span className='text-xs w-10 font-semibold'>See All</span>
            </div>
            {imgArray.map((item)=>{
                return <div className="flex items-center justify-center h-12 w-72 my-2">
                <img src={item.imgId} className='rounded-full h-12 w-12' alt="pic" />
                <div className='w-44 h-8 flex-col ml-2'>
                <p className='w-40 h-4 text-sm font-semibold'>{item.profileName} </p>
                <p className='w-40 h-4 text-xs text-zinc-500'>{item.content} </p>
                </div>
                <span className='text-sky-500 text-xs font-semibold'>{item.followStatus} </span>
            </div>
            })}
        </div>
    );
