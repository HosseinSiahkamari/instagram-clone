...
const SideBar = () => {
    ...
    return (<div>
        ...
        <div className="fixed left-0 bottom-0 w-full flex justify-center items-center bg-slate-50 h-16 border-t-2 md:hidden ">
            <div className='flex justify-between items-center w-full'>
                {menuIconsBottom.map((item, index) => {
                    return <div className='flex justify-center items-center ' key={index}>{item} </div>
                })}
            </div>
        </div>
    </div>);
